    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm sm:text-base text-[#0F1012]">Everything you need to know about shipping and delivery.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {shippingOptions.map((option, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                ...
                <p className="text-sm text-[#0F1012] mb-3">{option.duration}</p>
                <p className="text-sm font-medium text-gray-900 mb-3">{option.price}</p>
                <p className="text-sm text-[#0F1012]">{option.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
            <div>
              ...
              <p className="text-[#0F1012]">All orders are processed within 1-2 business days (excluding weekends and holidays). Orders placed after 2 PM will be processed the next business day.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Delivery Areas</h3>
              <p className="text-[#0F1012]">We ship to all major cities and towns across India. For remote locations, delivery may take additional 2-3 business days. International shipping is not currently available.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Tracking Your Order</h3>
              <p className="text-[#0F1012]">Once your order is shipped, you'll receive a tracking number via email and SMS. You can track your order status in real-time through your account dashboard or by using the tracking link provided.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Delivery Attempts</h3>
              <p className="text-[#0F1012]">Our delivery partner will attempt delivery up to 3 times. If delivery fails, your order will be returned to us. Please ensure someone is available to receive the package or provide accurate delivery instructions.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Undeliverable Packages</h3>
              <p className="text-[#0F1012]">If a package is returned to us due to an incorrect address or failed delivery attempts, we'll contact you to arrange reshipment. Additional shipping charges may apply.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 text-center">
          ...
          <p className="text-[#0F1012] mb-4">If you have questions about your shipment or need assistance, our customer service team is here to help.</p>
          <Link
            to="/contact"
