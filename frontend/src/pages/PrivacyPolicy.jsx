    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm sm:text-base text-[#0F1012]">Version 1.0 • Last updated: {getCurrentDate()}</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
          ...
          <section>
            ...
            <div className="space-y-3">
              <div>
                <p className="text-[#0F1012] leading-relaxed font-semibold">Personal Information:</p>
                <p className="text-[#0F1012] leading-relaxed ml-4">Name, email address, phone number, shipping/billing address and other details provided during checkout or account creation.</p>
              </div>
              <div>
                <p className="text-[#0F1012] leading-relaxed font-semibold">Order & Transaction Information:</p>
                <p className="text-[#0F1012] leading-relaxed ml-4">Products purchased (sarees and accessories), order history, payment method used and transaction identifiers. Card details are processed securely by our payment gateway; we do not store your full card information.</p>
              </div>
              <div>
                <p className="text-[#0F1012] leading-relaxed font-semibold">Account Information:</p>
                <p className="text-[#0F1012] leading-relaxed ml-4">Username, password, preferences, saved addresses and wishlist items (if you create an account).</p>
              </div>
              <div>
                <p className="text-[#0F1012] leading-relaxed font-semibold">Usage Data:</p>
                <p className="text-[#0F1012] leading-relaxed ml-4">Pages visited, time spent, clicked links and other analytical data regarding how you use our website.</p>
              </div>
              <div>
                <p className="text-[#0F1012] leading-relaxed font-semibold">Device & Technical Data:</p>
                <p className="text-[#0F1012] leading-relaxed ml-4">IP address, browser type, device type, operating system and similar technical information.</p>
              </div>
              <div>
                <p className="text-[#0F1012] leading-relaxed font-semibold">Communication Data:</p>
                <p className="text-[#0F1012] leading-relaxed ml-4">Messages, reviews, queries or feedback you send via forms, email, WhatsApp or social media.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-[#0F1012] leading-relaxed mt-3">
