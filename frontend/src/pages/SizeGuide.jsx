    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm sm:text-base text-[#0F1012]">Find your perfect fit with our comprehensive size guide.</p>
        </div>
        ...
        <div className="mb-8 sm:mb-12 bg-white rounded-lg shadow-sm p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-[#0F1012] text-sm">
            ...
            <table className="w-full border-collapse min-w-[500px]">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Size</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Chest (inches)</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Waist (inches)</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Length (inches)</th>
                </tr>
              </thead>
              <tbody>
                {mensSizes.map((item, index) => (
                  <tr key={index} className="hover:bg-[#FE1157]/10">
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">{item.size}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.chest}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.waist}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.length}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <table className="w-full border-collapse min-w-[500px]">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Size</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Bust (inches)</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Waist (inches)</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Hips (inches)</th>
                </tr>
              </thead>
              <tbody>
                {womensSizes.map((item, index) => (
                  <tr key={index} className="hover:bg-[#FE1157]/10">
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">{item.size}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.bust}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.waist}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.hips}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="mb-8 sm:mb-12 bg-white rounded-lg shadow-sm p-4 sm:p-6">
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <table className="w-full border-collapse min-w-[400px]">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">US</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">UK</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">EU</th>
                  <th className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">CM</th>
                </tr>
              </thead>
              <tbody>
                {shoeSizes.map((item, index) => (
                  <tr key={index} className="hover:bg-[#FE1157]/10">
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">{item.us}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.uk}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.eu}</td>
                    <td className="border border-[#FE1157] px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-[#0F1012]">{item.cm}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="mb-12 bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3 text-[#0F1012]">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 text-center">
          ...
          <p className="text-[#0F1012] mb-4">Our customer service team can help you find the perfect fit. Contact us for personalized sizing assistance.</p>
          <Link
            to="/contact"
