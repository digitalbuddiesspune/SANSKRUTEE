    ...
    <div className="min-h-screen bg-[#FFFFFF] lg:hidden">
      ...
      <div className="bg-[#0F1012] text-[#FFFFFF] sticky top-0 z-10">
        <div className="px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#FFFFFF]/80">Email & SMS preferences</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-3">
        {[
          ...
          <label key={item.id} className="flex items-start gap-4 p-5 border border-[#FE1157] bg-white/60 backdrop-blur-sm rounded-lg cursor-pointer hover:bg-white/80 transition-colors luxury-shadow-sm">
            ...
            <div className="flex-1">
              ...
              <span className="block text-xs text-[#0F1012] mt-1">{item.description}</span>
            </div>
          </label>
        ))}
      </div>
