    ...
    <div className="min-h-screen bg-[#FAF6F0] lg:hidden">
      ...
      <div className="bg-[#1A2F2A] text-[#F5F0E8] sticky top-0 z-10">
        <div className="px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#F5F0E8]/80">Email & SMS preferences</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-3">
        {[
          ...
          <label key={item.id} className="flex items-start gap-4 p-5 border border-[#E0D8CE] bg-white/60 backdrop-blur-sm rounded-lg cursor-pointer hover:bg-white/80 transition-colors luxury-shadow-sm">
            ...
            <div className="flex-1">
              ...
              <span className="block text-xs text-[#8B9A95] mt-1">{item.description}</span>
            </div>
          </label>
        ))}
      </div>
