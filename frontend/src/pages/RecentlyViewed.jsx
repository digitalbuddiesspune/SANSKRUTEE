      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            ...
            <p className="text-[#0F1012] mb-4">Start browsing to see your recently viewed items here</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-[#0F1012] mt-1">{products.length} product{products.length !== 1 ? 's' : ''}</p>
          </div>
          <button
            onClick={() => {
            ...
            className="text-sm text-[#0F1012] hover:text-gray-900"
          >
            Clear All
          </button>
        </div>
